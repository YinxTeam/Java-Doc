---
title: "交易主链路提供风控决策要求RT_5ms的技术方案"
author: Hollis
category:
  - Java八股文
---

# 交易主链路提供风控决策要求RT_5ms的技术方案
...
![](./assets/交易主链路提供风控决策要求RT_5ms的技术方案-1.png)

![](./assets/交易主链路提供风控决策要求RT_5ms的技术方案-2.png)

CPU：2.95%  
MEM：29%  
LOAD：0.05-0.25

![image.png](./assets/交易主链路提供风控决策要求RT_5ms的技术方案-3.png)

![image.png](./assets/交易主链路提供风控决策要求RT_5ms的技术方案-4.png)

## 调用链路

```mermaid
sequenceDiagram
  主站交易->>风控决策: batchAdmit
  风控决策->>tair: getAllPresent
  风控决策->>tair: decision
  风控决策->>主站交易: result
```

![图表](./assets/交易主链路提供风控决策要求RT_5ms的技术方案-5.svg)
...
[43.架构设计_什么是单元化架构](../43.架构设计/什么是单元化架构.md)
...
![](./assets/交易主链路提供风控决策要求RT_5ms的技术方案-6.png)
...
![图表](./assets/交易主链路提供风控决策要求RT_5ms的技术方案-7.svg)
...
![](./assets/交易主链路提供风控决策要求RT_5ms的技术方案-8.png)
...
![图表](./assets/交易主链路提供风控决策要求RT_5ms的技术方案-9.svg)
