...
![image.png](./assets/Java是如何实现的平台无关_-5.png)
...
[05.JVM_Java一定就是平台无关的吗](./Java一定就是平台无关的吗.md)
