...
[05.JVM_新生代和老年代的GC算法](./新生代和老年代的GC算法.md)

根据默认配置，新生代有一个 Eden区，两个survivor区，eden区占80%内存空间，每一块survivor区占 10%

![image.png](./assets/新生代如果只有一个Eden+一个Survivor可以吗_-1.png)
...
![image.png](./assets/新生代如果只有一个Eden+一个Survivor可以吗_-2.png)

如果此时Eden区进行YoungGC之后，会如下图所示：

![image.png](./assets/新生代如果只有一个Eden+一个Survivor可以吗_-3.png)

那么，接下来继续创建对象的时候，如果继续向Eden分配：

![image.png](./assets/新生代如果只有一个Eden+一个Survivor可以吗_-4.png)
...
![image.png](./assets/新生代如果只有一个Eden+一个Survivor可以吗_-5.png)
...
![image.png](./assets/新生代如果只有一个Eden+一个Survivor可以吗_-6.png)
