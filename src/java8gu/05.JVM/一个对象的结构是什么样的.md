...
![image.png](./assets/一个对象的结构是什么样的_-2.png)
...
\_metadata是一个共用体，其中\_klass是普通指针，\_compressed\_klass是压缩类指针。这两个指针都指向instanceKlass对象，它用来描述对象的具体类型。
