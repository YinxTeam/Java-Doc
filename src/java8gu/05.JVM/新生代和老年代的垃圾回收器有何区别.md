...
![image.png](./assets/新生代和老年代的垃圾回收器有何区别_-1.png)
...
[05.JVM_介绍下CMS的垃圾回收过程](./介绍下CMS的垃圾回收过程.md)

## 并发回收与并行回收

[05.JVM_说一说JVM的并发回收和并行回收](./说一说JVM的并发回收和并行回收.md)

## G1

[05.JVM_为什么G1从JDK_9之后成为默认的垃圾回收器](./为什么G1从JDK_9之后成为默认的垃圾回收器.md)
