...
![image.png](./assets/Java的堆是如何分代的_为什么分代_-1.png)
...
![image.png](./assets/Java的堆是如何分代的_为什么分代_-2.png)
...
[05.JVM_新生代如果只有一个Eden+一个Survivor可以吗](./新生代如果只有一个Eden+一个Survivor可以吗.md)
