...
![](./assets/JVM有哪些垃圾回收算法_-3.png)

在回收前将存活的对象复制到另一边去。然后再回收垃圾对象，回收完就类似下面的样子：

![](./assets/JVM有哪些垃圾回收算法_-4.png)
...
![](./assets/JVM有哪些垃圾回收算法_-5.png)

下图表示的第一阶段：标记出存活对象和垃圾对象

![](./assets/JVM有哪些垃圾回收算法_-6.png)

白色空间表示被清理后的垃圾。

下面就开始进行整理：

![](./assets/JVM有哪些垃圾回收算法_-7.png)
