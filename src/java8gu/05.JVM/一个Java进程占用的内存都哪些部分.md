...
![image.png](./assets/一个Java进程占用的内存都哪些部分_-1.png)
...
[05.JVM_什么是堆外内存_如何使用堆外内存](./什么是堆外内存_如何使用堆外内存.md)

![image.png](./assets/一个Java进程占用的内存都哪些部分_-2.png)
...
[05.JVM_JVM的运行时内存区域是怎样的](./JVM的运行时内存区域是怎样的.md)
