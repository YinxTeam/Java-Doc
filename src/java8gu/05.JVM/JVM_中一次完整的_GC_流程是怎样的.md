---
title: "JVM_中一次完整的_GC_流程是怎样的"
author: Hollis
category:
  - Java八股文
---

# JVM_中一次完整的_GC_流程是怎样的
...
![image.png](./assets/JVM_中一次完整的_GC_流程是怎样的_-1.png)
...
[05.JVM_新生代如果只有一个Eden+一个Survivor可以吗](./新生代如果只有一个Eden+一个Survivor可以吗.md#rx6Hh)
