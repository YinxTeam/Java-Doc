...
[05.JVM_OutOfMemory和StackOverflow的区别是什么](../05.JVM/OutOfMemory和StackOverflow的区别是什么.md)

### 问题发现

某次双十一之前，线上突然出现大量报警。服务的调用方很多人也反馈请求超时的情况很多：

![image.png](./assets/OOM问题排查过程-1.png)

后来发现同时线上存在GC耗时特别长，GC也特别频繁的情况

![image.png](./assets/OOM问题排查过程-2.png)
...
![image.png](./assets/OOM问题排查过程-3.png)
...
![image.png](./assets/OOM问题排查过程-4.png)
