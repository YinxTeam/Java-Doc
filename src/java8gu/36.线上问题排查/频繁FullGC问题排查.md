...
![image.png](./assets/频繁FullGC问题排查-1.png)
...
![image.png](./assets/频繁FullGC问题排查-2.png)

![image.png](./assets/频繁FullGC问题排查-3.png)

可以看到，存在非常多的Scrip\_${timestamp}\_${idx}类型的类
...
-   className="Script\_" + System.currentTimeMillis() + "\_" + CLASS\_COUNTER.getAndIncrement(); \- 与metaspace区的类信息吻合
