...
不管是因为什么情况了，是真的消费失败了，还是出现了异常了，还是明明消费成功了，但是你错误的返回了失败等等情况，只要你给RocketMQ返回的是 RECONSUME\_LATER ，那么消息就会重投，有重投就会有重复消费。
...
[17.RocketMQ_RocketMQ和Kafka一样有重平衡的问题吗](./RocketMQ和Kafka一样有重平衡的问题吗.md)
