...
![image.png](./assets/什么是InnoDB的页分裂和页合并-1.png)
...
![image.png](./assets/什么是InnoDB的页分裂和页合并-2.png)
...
![image.png](./assets/什么是InnoDB的页分裂和页合并-3.png)
...
[08.MySQL_char和varchar的区别](./char和varchar的区别.md)

[08.MySQL_MySQL的主键一定是自增的吗](./MySQL的主键一定是自增的吗.md)
