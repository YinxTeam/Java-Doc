...
配置生效后，如果有SQL的执行时长超过long\_query\_time 配置的时间阈值，那么就会打印慢SQL日志
...
[08.MySQL_如何进行SQL调优](./如何进行SQL调优.md)

一般来说，大多数情况，是可以通过执行计划分析出一条SQL的慢的原因的，大部分来说，主要是索引的问题和join的问题了。

关于执行计划的分析，索引失效等可以参考下面几篇，介绍的很详细了：

[08.MySQL_SQL执行计划分析的时候,要关注哪些信息](./SQL执行计划分析的时候,要关注哪些信息.md)

[08.MySQL_索引失效的问题如何排查](./索引失效的问题如何排查.md)
...
[36.线上问题排查_慢SQL问题排查](../36.线上问题排查/慢SQL问题排查.md)
