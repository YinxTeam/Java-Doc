...
在进行排序时，MySQL 会给每个线程分配一块内存用于排序，称为 sort\_buffer，它的大小是由`sort_buffer_size`控制的。
...
![image.png](./assets/order_by_是怎么实现的_-1.png)
...
![image.png](./assets/order_by_是怎么实现的_-2.png)
