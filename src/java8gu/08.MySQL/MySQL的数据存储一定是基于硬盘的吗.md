...
查看mysql当前默认的存储引擎:show variables like '%storage\_engine%';
...
create table table1(id int(11) primary key auto\_increment)engine=MyISAM;
...
![image.png](./assets/MySQL的数据存储一定是基于硬盘的吗_-1.png)

## Innodb和MyISAM有什么区别？

[08.MySQL_InnoDB和MyISAM有什么区别](./InnoDB和MyISAM有什么区别.md)
