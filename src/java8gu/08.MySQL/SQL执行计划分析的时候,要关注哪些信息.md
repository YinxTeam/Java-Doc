...
-   `explain select count(*),b from t2 group by b;` 参考：[08.MySQL_order_by_是怎么实现的](./order_by_是怎么实现的.md) 、 [08.MySQL_Using_filesort_能优化吗,怎么优化](./Using_filesort_能优化吗,怎么优化.md)
