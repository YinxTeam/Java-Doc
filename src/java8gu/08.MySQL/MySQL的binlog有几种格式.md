...
[08.MySQL_binlog、redolog和undolog区别](./binlog、redolog和undolog区别.md)
...
[08.MySQL_MySQL的limit+order_by为什么会数据重复](./MySQL的limit+order_by为什么会数据重复.md)

还有就是下面这篇文章中提到的情况了：

[08.MySQL_为什么MySQL默认使用RR隔离级别](./为什么MySQL默认使用RR隔离级别.md)
