---
title: "MySQL的驱动表是什么_MySQL怎么选的"
author: Hollis
category:
  - Java八股文
---

# MySQL的驱动表是什么_MySQL怎么选的
...
如上图，orders表为驱动表，order\_details表为非驱动表。
...
在MySQL中，可以使用"STRAIGHT\_JOIN"关键字来强制指定JOIN语句中的表连接顺序。使用"STRAIGHT\_JOIN"可以告诉优化器使用查询中表的顺序，而不再重新优化连接顺序。
