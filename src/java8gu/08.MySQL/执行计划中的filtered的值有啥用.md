...
所以在mysql官网中，介绍filtered的时候（[https://dev.mysql.com/doc/refman/8.4/en/explain-output.html#explain\_filtered](https://dev.mysql.com/doc/refman/8.4/en/explain-output.html#explain_filtered)），特意提了join的事儿：

![image.png](./assets/执行计划中的filtered的值有啥用_-1.png)
