...
![](./assets/为什么MySQL默认使用RR隔离级别_-1.jpeg)
...
![](./assets/为什么MySQL默认使用RR隔离级别_-2.jpeg)
...
[08.MySQL_MySQL的binlog有几种格式](./MySQL的binlog有几种格式.md)
...
[08.MySQL_为什么默认RR,大厂要改成RC](./为什么默认RR,大厂要改成RC.md)
