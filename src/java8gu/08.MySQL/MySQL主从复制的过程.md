...
[08.MySQL_InnoDB的一次更新事务过程是怎么样的](./InnoDB的一次更新事务过程是怎么样的.md)
...
![image.png](./assets/MySQL主从复制的过程-1.png)
...
![image.png](./assets/MySQL主从复制的过程-2.png)

## 主从延迟

[08.MySQL_什么是数据库的主从延迟,如何解决](./什么是数据库的主从延迟,如何解决.md)

## 并行复制

[08.MySQL_MySQL的并行复制原理](./MySQL的并行复制原理.md)
