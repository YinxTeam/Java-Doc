...
[08.MySQL_什么是排他锁和共享锁](./什么是排他锁和共享锁.md)
...
![image.png](./assets/介绍下InnoDB的锁机制_-1.png)
...
[08.MySQL_高并发情况下自增主键会不会重复,为什么](./高并发情况下自增主键会不会重复,为什么.md)
...
[08.MySQL_InnoDB中的表级锁、页级锁、行级锁](./InnoDB中的表级锁、页级锁、行级锁.md)
...
[08.MySQL_乐观锁与悲观锁如何实现](./乐观锁与悲观锁如何实现.md)
