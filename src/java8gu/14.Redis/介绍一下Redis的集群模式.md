...
![image.png](./assets/介绍一下Redis的集群模式_-1.png)
...
![image.png](./assets/介绍一下Redis的集群模式_-2.png)
...
![image.png](./assets/介绍一下Redis的集群模式_-3.png)
...
![image.png](./assets/介绍一下Redis的集群模式_-4.png)
...
[14.Redis_什么是Redis的数据分片](./什么是Redis的数据分片.md)

关于 Cluster 中存在对事务和 lua 的限制，参考：

[14.Redis_Redis_Cluster_中使用事务和_lua_有什么限制](./Redis_Cluster_中使用事务和_lua_有什么限制.md)
