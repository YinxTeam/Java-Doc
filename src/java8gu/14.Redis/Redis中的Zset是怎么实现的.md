...
![image.png](./assets/Redis中的Zset是怎么实现的_-1.png)
...
[14.Redis_ZSet为什么在数据量少的时候用ZipList,而在数据量大的时候转成SkipList](./ZSet为什么在数据量少的时候用ZipList,而在数据量大的时候转成SkipList.md)
...
![image.png](./assets/Redis中的Zset是怎么实现的_-2.png)
...
![image.png](./assets/Redis中的Zset是怎么实现的_-3.png)

# 扩展知识

## ZipList和ListPack区别

[14.Redis_Redis的ZipList、SkipList和ListPack之间有什么区别](./Redis的ZipList、SkipList和ListPack之间有什么区别.md)
...
![image.png](./assets/Redis中的Zset是怎么实现的_-4.png)
...
![image.png](./assets/Redis中的Zset是怎么实现的_-5.png)
