---
title: "Redis_Cluster_中使用事务和_lua_有什么限制"
author: Hollis
category:
  - Java八股文
---

# Redis_Cluster_中使用事务和_lua_有什么限制
...
[14.Redis_介绍一下Redis的集群模式](./介绍一下Redis的集群模式.md)
...
当我们要跨节点执行 lua 的时候，会报错提示：command keys must in same slot。（详见：[https://redis.io/docs/latest/operate/oss\_and\_stack/reference/cluster-spec/](https://redis.io/docs/latest/operate/oss_and_stack/reference/cluster-spec/) ）

### 如何解决？

[14.Redis_如何在_Redis_Cluster_中执行_lua_脚本](./如何在_Redis_Cluster_中执行_lua_脚本.md)
