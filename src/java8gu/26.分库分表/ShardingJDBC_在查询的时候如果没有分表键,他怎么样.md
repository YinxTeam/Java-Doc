---
title: "ShardingJDBC_在查询的时候如果没有分表键,他怎么样"
author: Hollis
category:
  - Java八股文
---

# ShardingJDBC_在查询的时候如果没有分表键,他怎么样
...
![image.png](./assets/ShardingJDBC_在查询的时候如果没有分表键,他怎么样_-1.png)
...
举个例子，我们的逻辑表t\_order，对应的物理表是t\_order\_01，t\_order\_02，t\_order\_03，t\_order\_00，而你的 SQL 是：
