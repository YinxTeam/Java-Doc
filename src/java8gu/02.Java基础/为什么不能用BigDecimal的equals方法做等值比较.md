...
![](./assets/为什么不能用BigDecimal的equals方法做等值比较_-1.jpeg)​
...
![1.jpeg](./assets/为什么不能用BigDecimal的equals方法做等值比较_-2.jpeg)
...
![2.jpeg](./assets/为什么不能用BigDecimal的equals方法做等值比较_-3.jpeg)
...
![3.jpeg](./assets/为什么不能用BigDecimal的equals方法做等值比较_-4.jpeg)
...
![4.jpeg](./assets/为什么不能用BigDecimal的equals方法做等值比较_-5.jpeg)
