---
title: "String_str=new_String(_hollis_)创建了几个对象"
author: Hollis
category:
  - Java八股文
---

# String_str=new_String(_hollis_)创建了几个对象
...
[05.JVM_什么是Class常量池,和运行时常量池关系是什么](../05.JVM/什么是Class常量池,和运行时常量池关系是什么.md)

[02.Java基础_字符串常量是什么时候进入到字符串常量池的](./字符串常量是什么时候进入到字符串常量池的.md)
...
[02.Java基础_String中intern的原理是什么](./String中intern的原理是什么.md)
