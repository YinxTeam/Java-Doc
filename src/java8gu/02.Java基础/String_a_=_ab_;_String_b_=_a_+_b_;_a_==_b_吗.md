---
title: "String_a_=_ab_;_String_b_=_a_+_b_;_a_==_b_吗"
author: Hollis
category:
  - Java八股文
---

# String_a_=_ab_;_String_b_=_a_+_b_;_a_==_b_吗
...
[02.Java基础_String、StringBuilder和StringBuffer的区别](./String、StringBuilder和StringBuffer的区别.md#TpASZ)
...
[05.JVM_运行时常量池和字符串常量池的关系是什么](../05.JVM/运行时常量池和字符串常量池的关系是什么.md)
