---
title: "Java和C++主要区别有哪些_各有哪些优缺点"
author: Hollis
category:
  - Java八股文
---

# Java和C++主要区别有哪些_各有哪些优缺点
...
[02.Java基础_如何理解面向对象和面向过程](./如何理解面向对象和面向过程.md)
...
[05.JVM_Java是编译型还是解释型](../05.JVM/Java是编译型还是解释型.md)
...
[05.JVM_Java是如何实现的平台无关](../05.JVM/Java是如何实现的平台无关.md)

-   Java是**自动内存管理和垃圾回收**的，C++需要手动内存管理，支持析构函数，Java没有析构函数的概念。

[05.JVM_JVM有哪些垃圾回收算法](../05.JVM/JVM有哪些垃圾回收算法.md)

[05.JVM_新生代和老年代的垃圾回收器有何区别](../05.JVM/新生代和老年代的垃圾回收器有何区别.md)

-   C++支持指针，引用，传值调用 。**Java只有值传递。**

[02.Java基础_Java是值传递还是引用传递](./Java是值传递还是引用传递.md)
