...
[33.设计模式_为什么说枚举是实现单例最好的方式](./为什么说枚举是实现单例最好的方式.md)
...
[04.Java并发_有了synchronized为什么还需要volatile](../04.Java并发/有了synchronized为什么还需要volatile.md)

# 扩展知识

## CAS实现单例

[42.场景题_不使用synchronized和Lock如何设计一个线程安全的单例](../42.场景题/不使用synchronized和Lock如何设计一个线程安全的单例.md)

## 如何破坏单例

[33.设计模式_如何破坏单例模式](./如何破坏单例模式.md)
