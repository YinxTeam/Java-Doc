...
![image.png](./assets/什么是SpringCloud,有哪些组件_-1.png)
...
[07.SpringCloud_Ribbon是怎么做负载均衡的](./Ribbon是怎么做负载均衡的.md)

3.  ~~OpenFeign：声明式HTTP客户端，可以帮助开发人员更容易地编写HTTP调用代码。~~

~~​~~  

[07.SpringCloud_OpenFeign_不支持了怎么办](./OpenFeign_不支持了怎么办.md)

4.  Hystrix：断路器组件，可以帮助应用程序处理服务故障和延迟问题。

[07.SpringCloud_Hystrix和Sentinel的区别是什么](./Hystrix和Sentinel的区别是什么.md)

5.  ~~Zuul：API网关，可以帮助应用程序处理API请求的路由、负载均衡、安全和监控等问题。~~

[07.SpringCloud_Zuul、Gateway和Nginx有什么区别](./Zuul、Gateway和Nginx有什么区别.md)
...
[07.SpringCloud_为什么需要SpringCloud_Gateway,他起到了什么作用](./为什么需要SpringCloud_Gateway,他起到了什么作用.md)
...
![image.png](./assets/什么是SpringCloud,有哪些组件_-2.png)
...
![](./assets/什么是SpringCloud,有哪些组件_-3.png)
