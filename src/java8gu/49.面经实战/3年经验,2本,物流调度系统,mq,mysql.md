...
[链接](https://www.yuque.com/hollis666/vzy8n3/qnsu1w1s7v0gr7xv)
...
[02.Java基础_BigDecimal和Long表示金额哪个更合适,怎么选择](../02.Java基础/BigDecimal和Long表示金额哪个更合适,怎么选择.md)

[42.场景题_订单到期关闭如何实现](../42.场景题/订单到期关闭如何实现.md)

[42.场景题_为什么不建议使用MQ实现订单到期关闭](../42.场景题/为什么不建议使用MQ实现订单到期关闭.md)

> **美团leaf生成订单号的方案介绍下。号段模式。步长是多少？什么是步长。号段相比雪花算法的好处是什么？号段模式有缺点吗？号段模式生成的单号是自增的吗？**

[13.分布式_Leaf生成分布式ID的原理](../13.分布式/Leaf生成分布式ID的原理.md)
...
[52.Oracle_Oracle_和_MySQL_的区别是什么_如何选择](../52.Oracle/Oracle_和_MySQL_的区别是什么_如何选择.md)

[08.MySQL_InnoDB和MyISAM有什么区别](../08.MySQL/InnoDB和MyISAM有什么区别.md)

[08.MySQL_where条件的顺序影响使用索引吗](../08.MySQL/where条件的顺序影响使用索引吗.md)

[08.MySQL_A,B,C的联合索引,按照_AB,AC,BC查询,能走索引吗](../08.MySQL/A,B,C的联合索引,按照_AB,AC,BC查询,能走索引吗.md)
...
[03.集合类_hash冲突通常怎么解决](../03.集合类/hash冲突通常怎么解决.md)

[03.集合类_Java_8中的Stream用过吗_都能干什么](../03.集合类/Java_8中的Stream用过吗_都能干什么.md)
