...
[42.场景题_索引失效的问题是如何排查的,有哪些种情况](../42.场景题/索引失效的问题是如何排查的,有哪些种情况.md#IfVVR)

[08.MySQL_a,b都有索引,select_from_table_where_a_=_xx_order_by_b。走哪个索引](../08.MySQL/a,b都有索引,select_from_table_where_a_=_xx_order_by_b。走哪个索引.md)
...
[13.分布式_Seata的实现原理是什么](../13.分布式/Seata的实现原理是什么.md)

[13.分布式_Seata的AT模式和XA有什么区别](../13.分布式/Seata的AT模式和XA有什么区别.md)
