...
[47.其他_SaaS系统中,多租户如何实现](../47.其他/SaaS系统中,多租户如何实现.md)
...
[47.其他_什么是流程引擎,请问流程引擎有什么优缺点](../47.其他/什么是流程引擎,请问流程引擎有什么优缺点.md)

> **项目难点？严格控制状态流程如何实现的？如何避免状态覆盖？乐观锁、**

[50.项目难点&亮点_基于状态机+乐观锁解决订单支付和关单的并发问题](../50.项目难点&亮点/基于状态机+乐观锁解决订单支付和关单的并发问题.md)

> **分布式事务****Seata AT****模式，****AT****出现脏读的原因是什么？****AT****的实现原理是什么？**
> 
> **TCC和AT有啥区别？代码侵入性、空回滚、事务悬挂，依赖事务，**

[13.分布式_Seata的AT模式的实现原理](../13.分布式/Seata的AT模式的实现原理.md)

[13.分布式_Seata的AT模式会不会出现脏读_为什么](../13.分布式/Seata的AT模式会不会出现脏读_为什么.md)

[13.分布式_TCC的空回滚和悬挂是什么_如何解决](../13.分布式/TCC的空回滚和悬挂是什么_如何解决.md)

[13.分布式_Seata的4种事务模式,各自适合的场景是什么](../13.分布式/Seata的4种事务模式,各自适合的场景是什么.md)
