...
[16.Kafka_Kafka的架构是怎么样的](./Kafka的架构是怎么样的.md)

在上面的文章中我们介绍过Kafka的架构，这里面有个很关键的组件，是Zookeeper。（但是后来被移除了，详见后文）

![](./assets/Kafka为什么依赖Zookeeper,有什么用_-1.png)
...
[16.Kafka_介绍一下Kafka的ISR机制](./介绍一下Kafka的ISR机制.md)
...
[16.Kafka_Kafka_几种选举过程简单介绍一下](./Kafka_几种选举过程简单介绍一下.md)
...
在2025-3-19日，Kafka 4.0发布后（[https://archive.apache.org/dist/kafka/4.0.0/RELEASE\_NOTES.html](https://archive.apache.org/dist/kafka/4.0.0/RELEASE_NOTES.html) ），则默认采用KRaft模型运行，不再依赖Zk。
