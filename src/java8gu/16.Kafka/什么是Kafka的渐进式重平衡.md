...
[16.Kafka_什么是Kafka的重平衡机制](./什么是Kafka的重平衡机制.md)
...
![image.png](./assets/什么是Kafka的渐进式重平衡_-1.png)
...
![image.png](./assets/什么是Kafka的渐进式重平衡_-2.png)
...
![image.png](./assets/什么是Kafka的渐进式重平衡_-3.png)

第二阶段：重新分配

-   Kafka 重新分配被释放的分区，则 ConsumerC 消费 Partition-2 和 Partition-5

![image.png](./assets/什么是Kafka的渐进式重平衡_-4.png)
