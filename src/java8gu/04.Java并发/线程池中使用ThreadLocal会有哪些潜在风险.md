...
[04.Java并发_ThreadLocal为什么会导致内存泄漏_如何解决的](./ThreadLocal为什么会导致内存泄漏_如何解决的.md)

其实这个问题就是上面这个问题的变形。（请仔细看上面这篇文章之后再学习本文，不然可能看不懂。）

如果在线程池中使用ThreadLocal，线程就要复用，就不会被销毁，ThreadLocal 变量不会自动清理，容易造成内存泄漏！

![image.png](./assets/线程池中使用ThreadLocal会有哪些潜在风险_-1.png)
...
[04.Java并发_JDK25的ScopedValue是什么_为什么可以替代ThreadLocal](./JDK25的ScopedValue是什么_为什么可以替代ThreadLocal.md)
