---
title: "run_start、wait_sleep、notify_notifyAll区别"
author: Hollis
category:
  - Java八股文
---

# run_start、wait_sleep、notify_notifyAll区别
...
**wait的线程会进入到WAITING状态，直到被唤醒**；sleep的线程会进入到TIMED\_WAITING状态，等到指定时间之后会再尝试获取CPU时间片。
