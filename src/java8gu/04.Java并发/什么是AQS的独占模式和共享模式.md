...
![image.png](./assets/什么是AQS的独占模式和共享模式_-1.png)

![image.png](./assets/什么是AQS的独占模式和共享模式_-2.png)

如Semaphore则是实现了tryAcquireShared、tryReleaseShared等方法：

![image.png](./assets/什么是AQS的独占模式和共享模式_-3.png)

其中也有tryAcquire的实现，但是也是调用了tryAcquireShared来实现的：

![image.png](./assets/什么是AQS的独占模式和共享模式_-4.png)
