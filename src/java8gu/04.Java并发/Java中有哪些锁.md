...
[04.Java并发_公平锁和非公平锁的区别](./公平锁和非公平锁的区别.md)

-   **偏向锁、轻量级锁、重量级锁**：涉及到`synchronized`的锁膨胀的过程。

[04.Java并发_synchronized的锁升级过程是怎样的](./synchronized的锁升级过程是怎样的.md)
...
[04.Java并发_CAS一定有自旋吗](./CAS一定有自旋吗.md)
...
[08.MySQL_介绍下InnoDB的锁机制](../08.MySQL/介绍下InnoDB的锁机制.md)

-   **无锁**：如volatile、不可变模式、ThreadLocal等。（为啥要提这个，因为他也是一种解决并发问题的方案）

[04.Java并发_如何实现无锁化编程](./如何实现无锁化编程.md)

-   **活锁 VS 死锁**

[04.Java并发_什么是活锁,和死锁有什么区别](./什么是活锁,和死锁有什么区别.md)
