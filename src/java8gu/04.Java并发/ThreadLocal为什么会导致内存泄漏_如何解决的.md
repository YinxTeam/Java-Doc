---
title: "ThreadLocal为什么会导致内存泄漏_如何解决的"
author: Hollis
category:
  - Java八股文
---

# ThreadLocal为什么会导致内存泄漏_如何解决的
...
[04.Java并发_什么是ThreadLocal,如何实现的](./什么是ThreadLocal,如何实现的.md)
...
![image.png](./assets/ThreadLocal为什么会导致内存泄漏_如何解决的_-6.png)
...
![image.png](./assets/ThreadLocal为什么会导致内存泄漏_如何解决的_-7.png)
...
[04.Java并发_为什么虚拟线程尽量避免使用ThreadLocal](./为什么虚拟线程尽量避免使用ThreadLocal.md)
