...
![image.png](./assets/Netty的Buffer为什么好用-3.png)

在写入的同时，我们可以直接通过readPointer读取数据，如下所示：

![image.png](./assets/Netty的Buffer为什么好用-4.png)
...
![image.png](./assets/Netty的Buffer为什么好用-5.png)
