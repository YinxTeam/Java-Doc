---
title: "海量数据查找最大的_k_个值,用什么数据结构"
author: Hollis
category:
  - Java八股文
---

# 海量数据查找最大的_k_个值,用什么数据结构
...
![image.png](./assets/海量数据查找最大的_k_个值,用什么数据结构_-1.png)

-   添加第三个元素（1）：1 小于堆顶元素（5），但是因为堆中还不满3个，所以1先入堆

![image.png](./assets/海量数据查找最大的_k_个值,用什么数据结构_-2.png)

-   添加第四个元素（3）：3 大于堆顶元素（1），所以3入堆。

![image.png](./assets/海量数据查找最大的_k_个值,用什么数据结构_-3.png)

-   添加第五个元素（10）：10大于5和3，移除3，添加10，堆更新为 5,15,10。

![image.png](./assets/海量数据查找最大的_k_个值,用什么数据结构_-4.png)

-   添加第六个元素（20）：20 大于堆顶元素（5），移除5，添加20。堆更新为 10,15,20。

![image.png](./assets/海量数据查找最大的_k_个值,用什么数据结构_-5.png)
