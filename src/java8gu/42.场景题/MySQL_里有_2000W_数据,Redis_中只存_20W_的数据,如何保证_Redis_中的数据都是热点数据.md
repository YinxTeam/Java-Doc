---
title: "MySQL_里有_2000W_数据,Redis_中只存_20W_的数据,如何保证_Redis_中的数据都是热点数据"
author: Hollis
category:
  - Java八股文
---

# MySQL_里有_2000W_数据,Redis_中只存_20W_的数据,如何保证_Redis_中的数据都是热点数据
...
[14.Redis_什么是热Key问题,如何解决热key问题](../14.Redis/什么是热Key问题,如何解决热key问题.md#ibN33)
