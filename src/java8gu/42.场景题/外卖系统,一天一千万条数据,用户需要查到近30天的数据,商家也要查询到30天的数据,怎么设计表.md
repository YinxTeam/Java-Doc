...
[13.分布式_什么是分布式数据库,有什么优势](../13.分布式/什么是分布式数据库,有什么优势.md)
...
[26.分库分表_分表字段如何选择](../26.分库分表/分表字段如何选择.md#LDks0)
...
![](./assets/外卖系统,一天一千万条数据,用户需要查到近30天的数据,商家也要查询到30天的数据,怎么设计表_-1.jpeg)
