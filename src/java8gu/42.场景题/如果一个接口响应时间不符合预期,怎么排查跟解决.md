...
[42.场景题_一次RPC请求,客户端显示超时,但是服务端不超时,可能是什么原因](./一次RPC请求,客户端显示超时,但是服务端不超时,可能是什么原因.md)
...
[36.线上问题排查_RT飙高问题排查过程](../36.线上问题排查/RT飙高问题排查过程.md)
...
[36.线上问题排查_Arthas统计方法耗时的原理是什么](../36.线上问题排查/Arthas统计方法耗时的原理是什么.md)
...
| 网络慢 | 同机房策略、单元化架构 |
| GC频繁 | JVM调优、调整堆大小 |
| 慢SQL | [08.MySQL_如何进行SQL调优](../08.MySQL/如何进行SQL调优.md) |
| 表中数据量大 | 分库分表、 分布式数据库 |
| 查询慢 | 加缓存 |
| 缓存失效 | 优化过期时间和淘汰策略 |
| 外部服务慢 | 异步调用 |
