...
![](./assets/你平常用哪些idea插件_-2.png)￼

分析完之后会有一个视图进行提示，详细的说明是哪种问题。

![](./assets/你平常用哪些idea插件_-3.png)
...
![](./assets/你平常用哪些idea插件_-4.jpeg)​

并且，该插件支持在编写代码的同时进行提示，

![](./assets/你平常用哪些idea插件_-5.jpeg)​
...
![](./assets/你平常用哪些idea插件_-7.jpeg)​

-   文本转换操作

-   切换样式（camelCase, hyphen-lowercase, HYPHEN-UPPERCASE, snake\_case, SCREAMING\_SNAKE\_CASE, dot.case, words lowercase, Words Capitalized, PascalCase）
-   转换为SCREAMING\_SNAKE\_CASE (或转换为camelCase)
-   转换为 snake\_case (或转换为camelCase)
-   转换为dot.case (或转换为camelCase)
-   转换为hyphen-case (或转换为camelCase)
-   转换为hyphen-case (或转换为snake\_case)
...
![](./assets/你平常用哪些idea插件_-8.jpeg)​

在弹出的对话框中，可以自动帮我们生成一份.ignore文件，这里我们让其帮忙自动排除所有和idea有关的文件。![](./assets/你平常用哪些idea插件_-9.jpeg)​
...
![](./assets/你平常用哪些idea插件_-10.jpeg)

![](./assets/你平常用哪些idea插件_-11.jpeg)
