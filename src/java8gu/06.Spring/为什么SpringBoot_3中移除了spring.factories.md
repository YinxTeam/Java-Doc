---
title: "为什么SpringBoot_3中移除了spring.factories"
author: Hollis
category:
  - Java八股文
---

# 为什么SpringBoot_3中移除了spring.factories
...
![image.png](./assets/为什么SpringBoot_3中移除了spring.factories-1.png)

![image.png](./assets/为什么SpringBoot_3中移除了spring.factories-2.png)

官方文档以及网上有很多资料也提到了，可以使用`org.springframework.boot.autoconfigure.AutoConfiguration.imports`文件替代。具体参考：

[06.Spring_如何自定义一个starter](./如何自定义一个starter.md)
...
[06.Spring_Spring_6.0和SpringBoot_3.0有什么新特性](./Spring_6.0和SpringBoot_3.0有什么新特性.md)
...
![image.png](./assets/为什么SpringBoot_3中移除了spring.factories-3.png)
