...
![image.png](./assets/SpringBoot的启动流程是怎么样的_-1.png)
...
![image.png](./assets/SpringBoot的启动流程是怎么样的_-2.png)
...
![image.png](./assets/SpringBoot的启动流程是怎么样的_-3.png)
...
![image.png](./assets/SpringBoot的启动流程是怎么样的_-4.png)
...
![image.png](./assets/SpringBoot的启动流程是怎么样的_-5.png)

最后，SpringBoot的启动过程主要流程如下：

![image.png](./assets/SpringBoot的启动流程是怎么样的_-6.png)
