...
[33.设计模式_三种工厂模式的区别和特点](../33.设计模式/三种工厂模式的区别和特点.md)
...
[06.Spring_介绍一下Spring的IOC](./介绍一下Spring的IOC.md)
...
![image.png](./assets/Spring中用到了哪些设计模式-1.png)
...
![](./assets/Spring中用到了哪些设计模式-2.webp)

## 观察者模式

具体可以参考：

[06.Spring_Spring在业务中常见的使用方式](./Spring在业务中常见的使用方式.md#a1dT6)
