...
![image.png](./assets/Autowired和Resource的关系_-1.png)
...
![image.png](./assets/Autowired和Resource的关系_-2.png)

Resource没有直接的 `required`属性。用它注入的Bean必须存在。如果找不到匹配的 Bean，会抛出异常。

![image.png](./assets/Autowired和Resource的关系_-3.png)
