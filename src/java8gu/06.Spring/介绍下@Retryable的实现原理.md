...
[06.Spring_Spring_7_和Spring_Boot_4_都有哪些新特性](./Spring_7_和Spring_Boot_4_都有哪些新特性.md)
...
> “退避”（Backoff）是在系统发生失败或异常后，延迟一段时间再重试的一种策略。比如RokcetMQ消息投递，用的就是一种叫做"指数退避"的退避策略。[27.定时任务_你知道有哪些退避策略吗](../27.定时任务/你知道有哪些退避策略吗.md)
