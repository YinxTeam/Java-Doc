---
title: "Spring_中注入_Bean_有几种方式"
author: Hollis
category:
  - Java八股文
---

# Spring_中注入_Bean_有几种方式
...
[06.Spring_为什么Spring不建议使用基于字段的依赖注入](./为什么Spring不建议使用基于字段的依赖注入.md)
...
[06.Spring_Autowired和Resource的关系](./Autowired和Resource的关系.md)
...
[06.Spring_BeanFactory和FactroyBean的关系](./BeanFactory和FactroyBean的关系.md)
