...
![image.png](./assets/为什么在JDK8中HashMap要转成红黑树-1.png)

但是，对于极端情况，当子节点都比父节点大或者小的时候，二叉查找树又会退化成链表，查询复杂度会重新变为O(N)，如下所示：

![image.png](./assets/为什么在JDK8中HashMap要转成红黑树-2.png)
...
![image.png](./assets/为什么在JDK8中HashMap要转成红黑树-3.png)
...
![image.png](./assets/为什么在JDK8中HashMap要转成红黑树-4.png)
