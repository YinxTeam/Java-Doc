---
title: "ConcurrentHashMap为什么在JDK_1.8中废弃分段锁"
author: Hollis
category:
  - Java八股文
---

# ConcurrentHashMap为什么在JDK_1.8中废弃分段锁
...
[03.集合类_ConcurrentHashMap是如何保证线程安全的](./ConcurrentHashMap是如何保证线程安全的.md)
...
[03.集合类_ConcurrentHashMap为什么在JDK1.8中使用synchronized而不是ReentrantLock](./ConcurrentHashMap为什么在JDK1.8中使用synchronized而不是ReentrantLock.md)
