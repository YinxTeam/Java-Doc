...
[03.集合类_HashMap的hash方法是如何实现的](./HashMap的hash方法是如何实现的.md)
...
![](./assets/为什么HashMap的Cap是2^n,如何保证_-1.jpeg)
...
[03.集合类_为什么HashMap的默认负载因子设置成0.75](./为什么HashMap的默认负载因子设置成0.75.md)

## HashMap的初始值设为多少合适？

[03.集合类_HashMap的容量设置多少合适](./HashMap的容量设置多少合适.md)
