...
![](./assets/什么是A2A,和MCP有什么区别_-1.png)
...
![](./assets/什么是A2A,和MCP有什么区别_-2.png)
...
3、服务端收到 Message 后，验证 task\_type 是否支持（对照自身 Agent Card），执行任务逻辑（可能调用工具、模型、外部 API 等），若任务生成具体产出（如图片、代码文件、报告等），则创建 Artifact。
