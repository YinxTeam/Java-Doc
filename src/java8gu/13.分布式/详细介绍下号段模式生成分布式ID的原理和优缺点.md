...
![image.png](./assets/详细介绍下号段模式生成分布式ID的原理和优缺点_-1.png)
...
![image.png](./assets/详细介绍下号段模式生成分布式ID的原理和优缺点_-2.png)

下次再有订单来创建的时候，因为他本地已经缓存了一个号段，那么他就直接用，把10001拿出来用就行了。

![image.png](./assets/详细介绍下号段模式生成分布式ID的原理和优缺点_-3.png)
...
![image.png](./assets/详细介绍下号段模式生成分布式ID的原理和优缺点_-4.png)
