...
[13.分布式_Seata的实现原理是什么](./Seata的实现原理是什么.md)
...
![111.jpg](./assets/Seata的AT模式的实现原理-1.jpeg)
...
5、把before/after image 以及业务 SQL 相关的信息组成一条回滚日志记录，插入到 UNDO\_LOG 表中。
...
![222.jpg](./assets/Seata的AT模式的实现原理-2.jpeg)
...
![333.jpg](./assets/Seata的AT模式的实现原理-3.jpeg)
...
![444.jpg](./assets/Seata的AT模式的实现原理-4.jpeg)
...
[13.分布式_Seata的AT模式会不会出现脏读_为什么](./Seata的AT模式会不会出现脏读_为什么.md)
