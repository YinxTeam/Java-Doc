...
![image.png](./assets/Seata的实现原理是什么-1.png)
...
![image.png](./assets/Seata的实现原理是什么-2.png)

3、RM通过其接收到的XID,将其所管理的资源且被该调用所使用到的资源注册为一个事务分支(Branch Transaction)

![image.png](./assets/Seata的实现原理是什么-3.png)
...
![image.png](./assets/Seata的实现原理是什么-4.png)  
...
[13.分布式_Seata的4种事务模式,各自适合的场景是什么](./Seata的4种事务模式,各自适合的场景是什么.md)
