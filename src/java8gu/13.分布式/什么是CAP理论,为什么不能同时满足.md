...
![image.png](./assets/什么是CAP理论,为什么不能同时满足_-1.png)

网上有很多关于CAP的介绍，其中关于一致性、可用性及分区容错性的介绍也有很多，但是这里需要重新纠正一下CAP中这三个特性的意思（[https://en.wikipedia.org/wiki/CAP\_theorem](https://en.wikipedia.org/wiki/CAP_theorem) ）：
...
[13.分布式_什么是分布式系统的一致性](./什么是分布式系统的一致性.md)
...
![](./assets/什么是CAP理论,为什么不能同时满足_-2.png)
...
![](./assets/什么是CAP理论,为什么不能同时满足_-3.png)
...
![](./assets/什么是CAP理论,为什么不能同时满足_-4.png)
...
[08.MySQL_MySQL是AP的还是CP的系统](../08.MySQL/MySQL是AP的还是CP的系统.md)
