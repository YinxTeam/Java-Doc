...
![](./assets/什么是TCC,和2PC有什么区别_-1.jpeg)
...
[13.分布式_TCC的空回滚和悬挂是什么_如何解决](./TCC的空回滚和悬挂是什么_如何解决.md)

# 扩展知识

## Confirm/Cancel失败了怎么办？

[13.分布式_TCC中,Confirm或者Cancel失败了怎么办](./TCC中,Confirm或者Cancel失败了怎么办.md)
...
[13.分布式_TCC是强一致性还是最终一致性](./TCC是强一致性还是最终一致性.md)
