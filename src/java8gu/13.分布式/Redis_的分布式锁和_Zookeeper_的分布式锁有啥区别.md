---
title: "Redis_的分布式锁和_Zookeeper_的分布式锁有啥区别"
author: Hollis
category:
  - Java八股文
---

# Redis_的分布式锁和_Zookeeper_的分布式锁有啥区别
...
![image.png](./assets/Redis_的分布式锁和_Zookeeper_的分布式锁有啥区别_-1.png)
...
[14.Redis_Redis是AP的还是CP的](../14.Redis/Redis是AP的还是CP的.md)
