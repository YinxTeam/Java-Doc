...
[07.SpringCloud_OpenFeign_不支持了怎么办](../07.SpringCloud/OpenFeign_不支持了怎么办.md)
...
[15.Dubbo_什么是RPC,和HTTP有什么区别](../15.Dubbo/什么是RPC,和HTTP有什么区别.md)
...
[16.Kafka_Kafka、ActiveMQ、RabbitMQ和RocketMQ都有哪些区别](../16.Kafka/Kafka、ActiveMQ、RabbitMQ和RocketMQ都有哪些区别.md)

### 服务网格

还有一种是新技术（其实也好多年了）——Service Mesh（服务网格），技术如Istio、Linkerd等，提供了对微服务之间通信的控制和管理能力，包括负载均衡、故障处理、安全策略等，通过Sidecar代理实现微服务的通信和控制。

[12.微服务_听说过ServiceMesh吗_是什么](./听说过ServiceMesh吗_是什么.md)
