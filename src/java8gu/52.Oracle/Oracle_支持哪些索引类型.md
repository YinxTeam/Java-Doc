...
[链接](https://www.yuque.com/hollis666/vzy8n3/dp3k5rl2a8yygtir)
...
[40.数据结构_什么是BitMap_有什么用](../40.数据结构/什么是BitMap_有什么用.md)

bitmap 索引将每个被索引的列的值作为 KEY，使用每个 bit 表示一行，当这行中包含这个值时，设置为 1，否则设置为 0。

如下图：

![image.png](./assets/Oracle_支持哪些索引类型_-1.png)
...
![image.png](./assets/Oracle_支持哪些索引类型_-2.png)
...
![image.png](./assets/Oracle_支持哪些索引类型_-3.png)
