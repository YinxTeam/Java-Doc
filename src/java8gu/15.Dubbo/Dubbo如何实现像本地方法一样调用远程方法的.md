...
![](./assets/Dubbo如何实现像本地方法一样调用远程方法的_-1.jpeg)

但是这样图片太复杂了，如果大家想要自己看源码，可以结合它来看，但是面试的时候回答问题，就不可能搞的这么细，所以主要还是介绍思想。（这里讲实现方式，具体的调用过程见：[15.Dubbo_Dubbo的服务调用的过程是什么样的](./Dubbo的服务调用的过程是什么样的.md) ）
...
![image.png](./assets/Dubbo如何实现像本地方法一样调用远程方法的_-2.png)
